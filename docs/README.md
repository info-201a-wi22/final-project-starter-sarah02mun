...
|---------------| -----------------|
|[Project Proposal](https://github.com/info-201a-wi22/final-project-starter-sarah02mun/blob/main/docs/p01-proposal.md) | Introduces our topic of concern, which is determining whether or not state and federal minimum wage levels have been enough to live on. We will explore this concept through our research questions which compare minimum wage levels to the average consumer price index.
